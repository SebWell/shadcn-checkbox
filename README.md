# 🎨 Shadcn/UI Checkbox for Weweb

Beautiful **Checkbox component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-checkbox`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The Checkbox component will appear in your elements!
